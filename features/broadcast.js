      ...
      if (!isGroup) {
        ...
        if (!text) {
          logger(
            "error",
            "broadcastgc",
            `Perintah salah contoh .broadcastgc thomz tamvan ganti dengan text masing-masing`
          );
          return replyCommand(
            `Perintah salah contoh .broadcasgc thomz tamvan ganti dengan text masing-masing`
          );
        }
        try {
